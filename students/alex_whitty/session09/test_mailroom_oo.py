...
class TestMailroom4(unittest.TestCase):
    ...
    def test_write_a_letter(self):
        actual = cli_main.write_a_letter('Paul Allen', 200)
    ...
    def test_create_summary(self):
        cli_main.donor_db = {"William Gates, III": [653772.32, 12.17, 15.123], "Jeff Bezos": [877.33, 1000.20]}
        actual = cli_main.create_summary()
    ...
    def test_letter_to_all_donors(self):
        ...
        with self.assertRaises(NameError):
            self.assertTrue(cli_main.letter_to_all_donors(amount), True)

    def test_report(self):
        self.assertEqual(cli_main.report(), None)

    def test_current_donor(self):
        current_donor = 'Elon Musk'
        self.assertEqual(current_donor, "Elon Musk")
        self.assertNotEqual(cli_main.add_donor(current_donor), current_donor)
